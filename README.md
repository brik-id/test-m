...
Ini adalah stack mobile yang kamu harus gunakan untuk proyek ini:
...
- State persistence, jika dibutuhkan save token (guna authentikasi), tentunya butuh di save di suatu tempat yang scure dong.
